...
const product1=new products('T-shirt Ahly adidas','90 $','Sports','images/product1.jpg',1);
const product2=new products('T-shirt madrid adidas','100 $','Sports ','images/product2.jpg',2);
const product3=new products('T-shirt Zmalake','80 $','Sports','images/product3.jpg',3);
const product4=new products('T-shirt Egypt PUMA','50 $','Sports','images/product4.jpg',4);
const product5=new products('Glasses','60 $','Men accessories','images/product5.jpg',5);
const product6=new products('Ball adidas World Cup','40 $','Men accessories','images/product6.jpg',6);
const product7=new products('Bag adidas',' 70 $','Bags','images/product7.jpg',7);
const product8=new products('Shoes adidas','80 $','sport','images/product8.jpg',8);
const product9=new products('Jacket','100 $','Sports','images/product9.jpg',9);
